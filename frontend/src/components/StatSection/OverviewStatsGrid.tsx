...
export function OverviewStatsGrid({
  ...
  return (
    <section className={styles.grid}>
      <StatCard
        label={t("dashboard.stats.totalMachines")}
      ...
      <StatCard
        ...
        pct={
          overview?.total
            ? Math.round((overview.working / overview.total) * 100)
            : undefined
        }
      />
      <StatCard
        ...
        pct={
          overview?.total
            ? Math.round((overview.lowSupply / overview.total) * 100)
            : undefined
        }
      />
      <StatCard
        ...
        pct={
          overview?.total
            ? Math.round((overview.needsRepair / overview.total) * 100)
            : undefined
        }
      />
    </section>
